      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            At MarryingMuslims, we are dedicated to protecting your privacy and ensuring the security of your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you use our Islamic matrimonial platform. Last updated: January 2024.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-red-50 rounded-lg p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-3">Profile Matching</h3>
            ...
            <div className="bg-red-50 rounded-lg p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-3">Safety & Security</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-red-50 rounded-lg p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-3">Service Improvement</h3>
              <p className="text-gray-700 text-sm">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">We may share information under the following circumstances:</p>
          
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              <span><strong>With Other Users:</strong> Profile information you choose to make visible</span>
            </li>
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              <span><strong>Service Providers:</strong>Trusted partners who assist in operating our platform</span>
            </li>
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              <span><strong>Legal Requirements:</strong> When required by law or to protect safety</span>
            </li>
            <li className="flex items-start">
              <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              <span><strong>Business Transfers:</strong> In case of merger or acquisition</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <p className="text-gray-700 mb-6">We implement industry-standard security measures to protect your personal information:</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Technical Safeguards</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Administrative Safeguards</h3>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-red-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="bg-red-50 rounded-lg p-6">
            ...
            <p className="text-gray-700 text-sm">
              ...
              <a href="mailto:help@marryingmuslims.com" className="text-red-500 hover:text-red-600 ml-1">
